...
- **UPDATE: For this project you should use [Selenium](https://cran.r-project.org/web/packages/RSelenium/RSelenium.pdf), rather than Rvest, to extract data from the page. There is a bug in some versions of Firefox that will give an error when you try to extract the HTML and hand it off to Rvest.**
